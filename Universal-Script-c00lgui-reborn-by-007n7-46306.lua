...
epikservertrollgui.Name = "epikservertrollgui"
epikservertrollgui.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
epikservertrollgui.ResetOnSpawn = false

Frame.Parent = epikservertrollgui
...
TextButton.MouseButton1Click:Connect(function()
	if Page1_2.Visible == true then
		Page1_2.Visible = false
		Page2_2.Visible = true
	elseif Page2_2.Visible == true then
...
if Page5.Visible == true then
	...
	elseif Page2_2.Visible == true then
		Page2_2.Visible = false
		Page1_2.Visible = true
	elseif Page1_2.Visible == true then
		Page1_2.Visible = false
		Page5.Visible = true
	end
end)
...
SettingsButton.MouseButton1Click:Connect(function()
	if cango == true then
		cango = false
		if SettingsButton.Text == "<" then
			SettingsButton.Text = ">"
			repeat
				wait()
				Settings.Position = UDim2.new(1, Settings.Position.X.Offset - 10, 0, 0)
			until Settings.Position.X.Offset <= -293
			wait()
			Settings.Position = UDim2.new(1, -300, 0, 0)
		else
			SettingsButton.Text = "<"
			repeat
				wait()
				Settings.Position = UDim2.new(1, Settings.Position.X.Offset + 10, 0, 0)
			until Settings.Position.X.Offset >= -10
			wait()
			Settings.Position = UDim2.new(1, 3, 0, 0)
		end
		cango = true
...
local lastSavedSkyboxID = nil
local lastSavedMusicID = nil

Save.MouseButton1Click:Connect(function()
    local skyboxInput = Frame.Settings.Page1["Skybox/Decal ID"].TextBox.Text
    local musicInput = Frame.Settings.Page1["Music ID"].TextBox.Text

    if skyboxInput ~= "" then
        lastSavedSkyboxID = skyboxInput
    end

    if musicInput ~= "" then
        lastSavedMusicID = musicInput
    end
end)
...
Load.MouseButton1Click:Connect(function()
    if lastSavedSkyboxID ~= nil then
        Frame.Settings.Page1["Skybox/Decal ID"].TextBox.Text = lastSavedSkyboxID
    else
        Frame.Settings.Page1["Skybox/Decal ID"].TextBox.Text = "158118263"
    end

    if lastSavedMusicID ~= nil then
        Frame.Settings.Page1["Music ID"].TextBox.Text = lastSavedMusicID
    else
        Frame.Settings.Page1["Skybox/Decal ID"].TextBox.Text = "157772998"
    end
end)
...
xBow.TextSize = 14
xBow.MouseButton1Click:Connect(function()
loadstring(game:HttpGetAsync("https://pastebin.com/raw/UpexViXw"))()
end)
...
Drage.TextSize = 14
Drage.MouseButton1Click:Connect(function()
loadstring(game:HttpGetAsync("https://pastebin.com/raw/AnkzsX0U"))()
end)
...
Eyelaser.MouseButton1Click:Connect(function()
local player = game.Players.LocalPlayer
local backpack = player:WaitForChild("Backpack")

local toolModel = game:GetObjects("rbxassetid://142007482")[1]
...
Wand.TextSize = 14
Wand.MouseButton1Click:Connect(function()
loadstring(game:HttpGetAsync("https://pastebin.com/raw/Zgvsnh0R"))()
end)
...
DualBlades.MouseButton1Click:Connect(function()
loadstring(game:HttpGetAsync("https://pastebin.com/raw/Zgvsnh0R"))()
end)
...
Lightsaber.MouseButton1Click:Connect(function()
...
MasterHand.MouseButton1Click:Connect(function()
loadstring(game:HttpGetAsync("https://pastebin.com/raw/erEs2pqG"))()
end)
...
game:GetObjects("rbxassetid://149941868")[1].Parent=game.Players.LocalPlayer.Backpack
end)
...
TechnoGauntlet.MouseButton1Click:Connect(function()
...
Plane.TextSize = 14
Plane.MouseButton1Click:Connect(function()
loadstring(game:HttpGetAsync("https://pastebin.com/raw/MTnLqKrC"))()
end)
...
Snowball.MouseButton1Click:Connect(function()
loadstring(game:HttpGetAsync("https://pastebin.com/raw/Xxwa0mMS"))()
end)
...
SuicideVest.MouseButton1Click:Connect(function()
...
CustomGear.MouseButton1Click:Connect(function()
...
StamperTools.MouseButton1Click:Connect(function()
...
ToolStealer.MouseButton1Click:Connect(function()
...
InsertTool.MouseButton1Click:Connect(function()
...
LaserRifle.MouseButton1Click:Connect(function()
...
DrawTool.MouseButton1Click:Connect(function()
...
ApocTroll.MouseButton1Click:Connect(function()
...
ClearTerrain.MouseButton1Click:Connect(function()
...
SetSkybox.MouseButton1Click:Connect(function()
local s = Instance.new("Sky")
s.Name = "Sky"
s.Parent = game.Lighting
local skyboxID = game.Players.LocalPlayer.PlayerGui.epikservertrollgui.Frame.Settings.Page1["Skybox/Decal ID"].TextBox.Text
...
ForceTeleport.MouseButton1Click:Connect(function()
...
CreateBaseplate.MouseButton1Click:Connect(function()
...
KohlsAdmin.MouseButton1Click:Connect(function()
game:GetObjects("rbxassetid://157676089")[1].Parent=game.Workspace
end)
...
NexPluviaAdmin.MouseButton1Click:Connect(function()
version="Pluvia"
Selection=1
TextBoxInUse=false
Player=nil
...
Nilizer.MouseButton1Click:Connect(function()
game:GetObjects("rbxassetid://142125914")[1].Parent=game.Players.LocalPlayer.Backpack
end)
...
RemsoAdmin.MouseButton1Click:Connect(function()
...
XAdmin.MouseButton1Click:Connect(function()
game:GetObjects("rbxassetid://149943200")[1].Parent=game.Players.LocalPlayer.Backpack
end)
...
LagGui.MouseButton1Click:Connect(function()
whoownit = game.Players.LocalPlayer
gui = Instance.new("ScreenGui")
gui.Parent = whoownit.PlayerGui
gui.Name = "Lag"
...
GlobalMessageGui.MouseButton1Click:Connect(function()
...
DZRSpawnItemGui.MouseButton1Click:Connect(function()
...
mainFrame.Size = UDim2.new(0, 223, 0, 45)
mainFrame.Position = UDim2.new(0, 0, 0, 409)
mainFrame.BackgroundColor3 = Color3.fromRGB(230, 230, 230)
mainFrame.BorderSizePixel = 1
mainFrame.Parent = screenGui

local weaponLabel = Instance.new("TextBox")
weaponLabel.Name = "WeaponLabel"
weaponLabel.Size = UDim2.new(0.85, 0, 0.5, 0)
weaponLabel.Position = UDim2.new(0, 0, 0, 0)
weaponLabel.BackgroundColor3 = Color3.fromRGB(245, 245, 245)
weaponLabel.BorderSizePixel = 1
weaponLabel.Text = "Precision Rifle"
weaponLabel.TextColor3 = Color3.fromRGB(0, 0, 0)
weaponLabel.TextSize = 14 -- Fixed: Use numeric value
weaponLabel.Font = Enum.Font.SourceSans
weaponLabel.Parent = mainFrame

local amountBox = Instance.new("TextBox")
amountBox.Name = "AmountBox"
amountBox.Size = UDim2.new(0.15, 0, 0.5, 0)
amountBox.Position = UDim2.new(0.85, 0, 0, 0)
amountBox.BackgroundColor3 = Color3.fromRGB(245, 245, 245)
amountBox.BorderSizePixel = 1
amountBox.Text = "1"
amountBox.TextColor3 = Color3.fromRGB(0, 0, 0)
amountBox.TextSize = 12 -- Fixed: Use numeric value
...
spawnButton.BackgroundColor3 = Color3.fromRGB(245, 245, 245)
spawnButton.BorderSizePixel = 1
spawnButton.Text = "Spawn"
spawnButton.TextColor3 = Color3.fromRGB(0, 0, 0)
spawnButton.TextSize = 12 -- Fixed: Use numeric value
...
spawnButton.MouseButton1Click:Connect(function()
	...
	if amount and amount > 0 then
		print("Spawning", weaponLabel.Text, "x" .. amount)
	else
		warn("Invalid amount:", amountBox.Text)
	end
end)
end)
...
Teamc00lkiddLogo1.MouseButton1Click:Connect(function()
Frame.Settings.Page1["Skybox/Decal ID"].TextBox.Text = 158118263
end)
...
Teamc00lkiddLogo2.MouseButton1Click:Connect(function()
...
ElectroSp00k.MouseButton1Click:Connect(function()
...
Wonga.TextSize = 14
Wonga.MouseButton1Click:Connect(function()
...
ChopSuey.MouseButton1Click:Connect(function()
...
Scream.TextSize = 14
Scream.MouseButton1Click:Connect(function()
...
BillboardGui.MouseButton1Click:Connect(function()
...
ChangeName.MouseButton1Click:Connect(function()
...
DiscoCharacter.MouseButton1Click:Connect(function()
...
ChickenArms.MouseButton1Click:Connect(function()
...
DominusGhost.MouseButton1Click:Connect(function()
...
AntiRobloxian.MouseButton1Click:Connect(function()
...
FloatingPad.MouseButton1Click:Connect(function()
...
HeadShake.MouseButton1Click:Connect(function()
...
MeshDisco.MouseButton1Click:Connect(function()
plr = game.Players.LocalPlayer.Name
...
RestoreSkybox.MouseButton1Click:Connect(function()
...
BecomeOwnerinPersonalServer.MouseButton1Click:Connect(function()
...
StealPlayerPoints.MouseButton1Click:Connect(function()
...
FencingRestore.MouseButton1Click:Connect(function()
...
LeaderstatAdd.MouseButton1Click:Connect(function()
while true do
wait(.1)
...
LeaderstatChange.MouseButton1Click:Connect(function()
game.Players.LocalPlayer.leaderstats:FindFirstChild(Frame.Settings.Page2["Leaderstat Name"].TextBox.Text)game.Players.LocalPlayer.leaderstats:FindFirstChild(Frame.Settings.Page2["Leaderstat Amount"].TextBox.Text)	
end)
...
LinkedSword.MouseButton1Click:Connect(function()
...
Icedagger.MouseButton1Click:Connect(function()
...
DualDarkhearts.MouseButton1Click:Connect(function()
...
DualVenomshanks.MouseButton1Click:Connect(function()
...
GhostfireSword.MouseButton1Click:Connect(function()
...
Hyperbike.MouseButton1Click:Connect(function()
...
CloseOpen.Parent = epikservertrollgui
...
m.Parent = Workspace
m.Text = "c00lgui Reborn V0.5 has loaded."
wait(3)
m:Destroy()

local m = Instance.new("Hint")
m.Parent = Workspace
m.Text = "c00lgui Reborn V0.5 has loaded! Remade by YepImSirPwnsAlot, Creds to 007n7"
wait(5)
m:Destroy()
